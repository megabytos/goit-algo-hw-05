...
if __name__ == '__main__':
    ...
    res = run_3_tests(text1, "Жадібний алгоритм")
    draw_table(res)
    res = run_3_tests(text1, "неіснуючий текст")
    draw_table(res)
    text2 = read_file('text2.txt')
    res = run_3_tests(text2, "Профілювання тестового коду")
    draw_table(res)
    res = run_3_tests(text2, "неіснуючий текст")
    draw_table(res)